    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
          <a class="nav-link" href="Login.jsp">
              <button class="btn btn-outline-danger my-2 my-sm-0" type="submit">Login</button></a>
      </li>
         <li class="nav-item">
             <a class="nav-link" href="Registration.jsp">
                 <button class="btn btn-outline-danger my-2 my-sm-0" type="submit">Register</button></a>
      </li>
...
<!--         <li class="nav-item">
         ...
         <li class="nav-item">
          ...
          <a class="nav-link" href="Adminlogin.jsp">
              <button class="btn btn-outline-danger my-2 my-sm-0" type="submit">Admin</button></a>
      </li>
...
virus would send a search request to a search engine and will use e-mail addresses obtained in the search results. Such a type of attack slowed down search engine services and caused some website crash. [15]          </p>
    ...
    <div id="antivirus div" style="display:none">
     ...
     <br> Antivirus software is a class of program designed to prevent, detect and remove malware infections on individual computing devices, networks and IT systems.<br>
...
Antivirus software usually performs these basic functions:<br>



Scanning directories or specific files for known malicious patterns indicating the presence of malicious software;<br>

Allowing users to schedule scans so they run automatically;<br>

Allowing users to initiate new scans at any time; and<br>
...
Types of antivirus programs<br>
...
While some operating systems are targeted more frequently by virus developers, antivirus software is available for most OSes:<br>

<br>Windows antivirus software.<br> 
...
<br>macOS antivirus software.<br>
...
Antivirus software uses a variety of virus detection techniques.<br>
...
Tablets</div>        
  ...
  <video src="virus.MP4" type="mp4" height="400px" width="1100px"  controls id="video" ></video>	
                   <button class="btn btn-success" id="playbutton" style="float:bottom;">PLAY</button>
                    ...
                    <div  id="antivirus">
                    <img style=height:100px; src="got%20a%20virus.png">
                    <h1 style="color:red; font-family:sans-serif;">Register <br><h3>By Registration You Can Get Daily Updates About Viruses And Other News,Able To Download Antiviruses.</h3></h1>
			...
			<script type=text/javascript src="js/bootstrap.js"></script> 
                        ...
                        <script type="text/javascript">
                           ...
                           commondiv.innerHTML= document.getElementById("typesofviruses div").innerHTML;
                            ...
                            commondiv.innerHTML= document.getElementById("antivirus div").innerHTML;
